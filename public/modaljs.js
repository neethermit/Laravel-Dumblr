  readaudio = new Audio('/Resources/01.ogg', '/Resources/01.mp3');
  ...
  $(document).on("click", ".openmodalEdit", function() {
      ...
      /*alert(this);
      alert($(".openmodalEdit"));
      alert($(".openmodalEdit").val);*/
      //var modalUpdateSong = document.getElementById('updateSongId' + $('#buttonUpdateSongId').val());
  ...
  $(document).ready(function() {
      ...
      if(typeof myProfileImage != "undefined"){
          $(".userpic").css("background-image", "url(" + myProfileImage + ")");
      }
      if(typeof profileImageURL != "undefined"){
          $(".profilepic").css("background-image", "url(" + profileImageURL + ")");
      }
